...
class ProfileViewController: UIViewController {
    ...
    let aboutMeLabel = UILabel(text: "You have the opportunity to chat with this man!", font: .systemFont(ofSize: 16, weight: .light))
    ...
    override func viewWillLayoutSubviews() {
        ...
        self.myTextField.rightView?.applyGradients(cornerRadius: 10)
    }
